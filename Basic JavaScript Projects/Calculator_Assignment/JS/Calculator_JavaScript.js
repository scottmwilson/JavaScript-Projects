...
const Calculator = {
    ...
    First_Operand: null,
    //This checks wether or not the second oerand has been inputted by the user. 
...
function Handle_Operator(Next_Operator) {
    ...
    //When an operator key is pressed we conver thte current number
    //displayed on teh screen to a number and then store the result in
    ...
    if (First_Operand == null) {
        ...
        //in the Preform_Calculation object and the function that matches th
...
keys.addEventListener('click', (event) => {
    ...
    //that was clicked. 
    const { target } = event; 
    //If the element that was clicjed on is not a button, exit the function. 
