...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //This calls a function to check fro any win conditions.
        checkWinConditions();
        //This condition is for changing the acitive player. 
        if (activePlayer === 'X') {
            //If active player is 'X' change it to 'O'/
            activePlayer = 'O'; 
            //if active player is anything other an 'X'
        } else { 
...
function checkWinConditions() {
    ...
    //This function checks fi an array includes 3 strings.  It is used to check for 
    //each win condition. 
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This indicates where the start of a lines x axis is. 
    let x1 = coordX1, 
        //This line indicates whre the start of a lines y axis is. 
        y1 = coordY1, 
        //This line indicates where the end of a lines x axis is. 
        x2 = coordX2, 
        //This lines indicates where th eend of a lines x axis is. 
        y2 = coordY2, 
